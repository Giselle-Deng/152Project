...
svymean(~interaction(school$vioinc08, ))
...
svytable(~c0174 + c0178 +strata, design = test_design)
...
?svyglm()
fit <- svyglm(vioinc08 ~ factor(c0174) + factor(c0176) + factor(c0178) + factor(c0180) + factor(c0264), design = hs_design)
summary(fit)
